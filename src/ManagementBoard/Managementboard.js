...
function Managementboard() {
    ...
    return (
        <div style={{ background: '#cecece', height: '830px' }}>
                ...
                sample1List.map((el, key) => {
                    return (
                        <div key={key}>
                            ...
                            <table class="type09">
                                <tbody>
                                <Link style={{ textDecoration: 'none', color: '#202f57' }} to={{ pathname: `/Joblist/Managementboardinfo?area=${el.area}&jobname=${el.jobname}&nickname=${el.nickname}&title=${el.title}` }}> 
                                <tr>
                                    <th scope="row">
                                    {el.title}
                                    </th>
            ...
            {
                nickname !== null
                    ? <div className="btn_area"><button className='loginbtn'><Link style={{ textDecoration: 'none', color: '#202f57' }} to={{ pathname: `/Joblist/Managementpost?area=${area}&jobname=${jobname}` }}><AiFillEdit size='30px' /></Link></button></div>
