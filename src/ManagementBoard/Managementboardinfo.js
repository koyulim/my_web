                        ...
                        <div key={key}>
                            ...
                            <div >
                                {el.nickname == nickname ?
                                    <div style={{ padding: '10px' }}>
                                        <button className='loginbtn'><Link style={{ textDecoration: 'none', color: '#202f57' }} to={{ pathname: `/Joblist/Managementrevise?area=${el.area}&jobname=${el.jobname}&nickname=${el.nickname}&title=${el.title}` }}>수정</Link></button>&nbsp;&nbsp;
