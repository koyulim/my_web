            ...
            return (
              <div key={key}>
                ...
                <div className='note' style={{ padding: '10px' }}>
                  ...
                  <a>&nbsp;&nbsp;</a>
                  <button className='loginbtn' ><Link style={{ textDecoration: 'none', color: '#660000'}} to={{pathname: `/Joblist/Serviceboard?area=${el.area}&jobname=${el.jobname}`}}>후기글 보기</Link></button>
                </div>
                <hr />
              </div>
            )
