                      ...
                      <tbody style={{ textAlign: 'center' }}>
                        <tr>
                          ...
                          <td><a style={{ padding: '10px' }}>
                            ...
                            <a>&nbsp;&nbsp;</a>
                            <button className='loginbtn'><Link style={{ textDecoration: 'none', color: '#202f57' }} to={{ pathname: `/Joblist/Serviceboard?area=${el.area}&jobname=${el.jobname}` }} >후기글 보기</Link></button>
                          </a>
                          </td>
                        </tr>
                      </tbody>
